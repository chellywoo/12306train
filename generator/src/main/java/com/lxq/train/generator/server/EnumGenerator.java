...
import com.lxq.train.member.enums.PassengerTypeEnum;
...
//    static String path = "admin/src/assets/js/enum.js";
    ...
    private static void toJson(Class clazz, StringBuffer bufferObject, StringBuffer bufferArray) throws Exception {
        ...
        // 生成对象
        bufferObject.append(enumConst).append("_ARRAY={");
        ...
        // 生成数组
        bufferArray.append(enumConst).append("=[");
        for (int i = 0; i < objects.length; i++) {
            Object obj = objects[i];
